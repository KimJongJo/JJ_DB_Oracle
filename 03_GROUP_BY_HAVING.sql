...
FROM EMPLOYEE
GROUP BY DECODE(SUBSTR(EMP_NO, 8, 1),'1','남','2','여') -- 별칭사용X (SELECT 절 해석 X (순서 확인))
ORDER BY 2; -- 별칭 사용 가능(SELECT절 해석 완료)
...
- MINUS (차집합) : A에서 A,B 교집한 부분을 제거하고 조회																			
