...
-- 사용자 계정 생성
CREATE USER music_chart IDENTIFIED BY music_chart;


-- 사용자 계정에 권한 부여
GRANT RESOURCE, CONNECT TO music_chart;


-- 객체가 생성될 수 있는 공간 할당량 지정
ALTER USER music_chart DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;
