...
-- 사용자 계정 생성
CREATE USER sample_diary IDENTIFIED BY sample_diary;


-- 사용자 계정에 권한 부여
GRANT RESOURCE, CONNECT TO sample_diary;


-- 객체가 생성될 수 있는 공간 할당량 지정
ALTER USER sample_diary DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;
