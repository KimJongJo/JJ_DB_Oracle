...
CREATE USER spring_kjj IDENTIFIED BY spring1234;

GRANT CONNECT, RESOURCE TO spring_kjj;

ALTER USER spring_kjj DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;
...
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$UbycwkWOXazuQdzZXa2EH.0v8BJbX3XHekTWZGN0Hk02kv9bkzW3S'
WHERE MEMBER_NO = 1;
