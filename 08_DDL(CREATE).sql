/*
 * - 데이터 딕셔너리
 * 데이터베이스에 저자된 데이터 구조, 메타데이터 정보를 포함하는 데이터베이스 객체
 * 
 ...
 * 			--> VARCHAR(10) 컬럼에 'ABC' 3BYTE 문자열만 저장하면 나머지 7BYTE 반환
 * 
 * DATE : 날짜 타입
 * 
 * BLOB : 대용량 이진 데이터 (4GB)
...
-- 가입일 -> SYSDATE를 활용
INSERT INTO "MEMBER" VALUES
('MEM02', 'QWER1234', '김영희', '94798-4987135', SYSDATE);
...
INSERT INTO "MEMBER" VALUES
('MEM04','PASS04','김길동', '948468-4984180', 
...
VALUES(1,'USER01','PASS01','홍길동','남자','010-4564-4984','hong123@kh.or.kr');

INSERT INTO USER_USED_NN
VALUES(NULL,'USER02','PASS02','홍길동','남자','010-4564-4984','hong123@kh.or.kr');
-- SQL Error [1400] [23000]: ORA-01400:
-- NULL을 ("KH_KJJ"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
INSERT INTO USER_USED_UK 
VALUES(1, 'USER01','PASS01','홍길동','남','010-1234-5678','hong123@kh.or.kr');
-- ORA-00001: 무결성 제약 조건(KH_KJJ.USER_ID_U)에 위배됩니다
...
-- ORA-00001: 무결성 제약 조건(KH_KJJ.USER_ID_NAME_U)에 위배됩니다
...
-- 한테이블당 한개만 설정할 수 있음
-- 컬럼레벨, 테이블레벨 둘다 설정 가능
-- 한 개 컬럼에 설정할 수 있고, 여러개의 컬럼을 묶어서 설정할 수 있다.
...
-- 기본키 중복 오류
-- ORA-00001: 무결성 제약 조건(KH_KJJ.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES(NULL, 'USER03','PASS03','유관순','여','010-1212-5678',' you123@kh.or.kr');
-- 기본키 NULL 이므로 오류
-- ORA-01400: NULL을 ("KH_KJJ"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
INSERT INTO USER_USED_PK2
VALUES(1, 'USER02','PASS02','이순시','남','010-1234-5678','hong123@kh.or.kr');
...
-- ORA-00001: 무결성 제약 조건(KH_KJJ.PK_USERNO_USERID)에 위배됩니다

INSERT INTO USER_USED_PK2
VALUES(NULL, 'USER01','PASS02','신사임당','여','010-1234-5678','hong123@kh.or.kr');
-- PRIMARY KEY는 NULL이 들어갈 수 없음
-- ORA-01400: NULL을 ("KH_KJJ"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
...
INSERT INTO USER_USED_FK
VALUES(3, 'USER03','PASS03','유관순','여','010-1515-5678','you123@kh.or.kr', 30);
...
INSERT INTO USER_USED_FK
VALUES(5, 'USER05','PASS05','윤봉길','남','010-1357-9764','yoon123@kh.or.kr', 50);
-- ORA-02291: 무결성 제약조건(KH_KJJ.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
--> 50이라는 값은 USER_GRADE 테이블 GRADE_CODE 컬럼에서제공하는 값이 아니므로
...
-- ORA-02292: 무결성 제약조건(KH_KJJ.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
-- ORA-02290: 체크 제약조건(KH_KJJ.GENDER_CHECK)이 위배되었습니다
...
VALUES(1, 'user01','pass01','880122-1234567','남','010-4568-4818','서울시 강남구 역삼동','N');

INSERT INTO USER_TEST
VALUES(2, 'user02','pass01','990122-1234567','여','010-4568-4818','서울시 광진구 중곡동','N');

INSERT INTO USER_TEST
VALUES(3, 'user03','pass01','000122-1234567','여','010-4568-4818','서울시 강남구 청담동','Y');

INSERT INTO USER_TEST
VALUES(4, 'user04','pass01','770122-1234567','남','010-4568-4818','서울시 강남구 도곡동','N');

INSERT INTO USER_TEST
VALUES(5, 'user05','pass01','660122-1234567','남','010-4568-4818','서울시 강남구 대치동','Y');
...
--> 참조 테이블의 PK(기본키)를 FK(외래키)로 지정하는 경우 참조 컬럼명 생략 가능
...
-- 참조테이블은 DEPARTMENT, 참조 컬럼 DEPARTMENT 테이블의 기본키
