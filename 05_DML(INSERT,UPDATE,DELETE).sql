...
VALUES('900', '장채현','901230-2345678','jang_ch@kh.or.kr', '01012341234', 'D1', 'J7', 'S3', 4300000, 0.2,
			 200, SYSDATE, NULL, 'N');
...
UPDATE DEPARTMENT2 SET
DEPT_ID = 'D0', DEPT_TITLE = '전략기획팀' -- WHERE절 직전 컬럼 작성 콤마 X
WHERE DEPT_ID = 'D9'
AND DEPT_TITLE = '총무부';
...
INSERT INTO EMP_M02
VALUES(999, '곽두원','561016-1234567','kwack_dw@kh.co.kr',
			'01012311231', 'D9','J4', 'S1', 9000000, 0.5, NULL, SYSDATE, NULL, DEFAULT);
